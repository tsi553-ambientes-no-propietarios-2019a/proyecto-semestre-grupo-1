...
// Returns the private 'App\Repository\UsrRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UsrRepository.php';

return $this->privates['App\\Repository\\UsrRepository'] = new \App\Repository\UsrRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
