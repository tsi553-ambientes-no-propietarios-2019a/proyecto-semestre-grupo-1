...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "SwiftmailerBundle:Collector:swiftmailer.html.twig", "/home/ubuntu/Info-q/vendor/symfony/swiftmailer-bundle/Resources/views/Collector/swiftmailer.html.twig");
    }
}
