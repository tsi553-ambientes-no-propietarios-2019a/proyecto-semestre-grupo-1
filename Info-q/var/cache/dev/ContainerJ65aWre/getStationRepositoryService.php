...
// Returns the private 'App\Repository\StationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/StationRepository.php';

return $this->privates['App\\Repository\\StationRepository'] = new \App\Repository\StationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
