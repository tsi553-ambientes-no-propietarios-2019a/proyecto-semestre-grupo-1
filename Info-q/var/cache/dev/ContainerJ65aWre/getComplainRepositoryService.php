...
// Returns the private 'App\Repository\ComplainRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ComplainRepository.php';

return $this->privates['App\\Repository\\ComplainRepository'] = new \App\Repository\ComplainRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
